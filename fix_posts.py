...
with open('app/api/routes/posts.py', 'w') as f:
    f.write(content)
print('posts done!')

comments_content = '''from fastapi import APIRouter, Depends, HTTPException
from sqlalchemy.orm import Session
...
with open('app/api/routes/comments.py', 'w') as f:
